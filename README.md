...
This web app: **allows users to create, edit, and delete crewmates stored in a Supabase table**
...
<img src='project8walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- routing the different pages together
